                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="m-sm-4">
                                ...
                                <form class="pt-5" action="{{route('user.dashboard')}}" method="get">
                                    <div class="row p-1">
                                        <div class="col">
                                    ...
                                    <button type="submit" class="btn btn-lg btn-scale">Sign up</button>
                                        <!-- <a href="index.html" class="btn btn-lg btn-scale">Sign up</a> -->
                                    </div>
                                    <div class="text-center mt-3">
                                        <a class="h6" href="{{route('login')}}" class="btn btn-lg">I have Account ! </a>
                                    </div>
                                </form>
                            </div>
                        </div>
